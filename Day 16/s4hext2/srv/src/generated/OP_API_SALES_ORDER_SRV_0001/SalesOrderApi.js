    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                CORRESPNC_EXTERNAL_REFERENCE: fieldBuilder.buildEdmTypeField('CorrespncExternalReference', 'Edm.String', true),
                /**
                 * Static representation of the {@link slsDocSo2PLastContactPersnName} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                SLS_DOC_SO_2_P_LAST_CONTACT_PERSN_NAME: fieldBuilder.buildEdmTypeField('SlsDocSo2PLastContactPersnName', 'Edm.String', true),
                /**
                 * Static representation of the {@link slsDocSo2PLstCntctPersnTelNmbr} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                SLS_DOC_SO_2_P_LST_CNTCT_PERSN_TEL_NMBR: fieldBuilder.buildEdmTypeField('SlsDocSo2PLstCntctPersnTelNmbr', 'Edm.String', true),
                /**
                 * Static representation of the {@link poCorrespncExternalReference} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                PO_CORRESPNC_EXTERNAL_REFERENCE: fieldBuilder.buildEdmTypeField('POCorrespncExternalReference', 'Edm.String', true),
                /**
                 * Static representation of the {@link customerConditionGroup1} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                CUSTOMER_CONDITION_GROUP_1: fieldBuilder.buildEdmTypeField('CustomerConditionGroup1', 'Edm.String', true),
                /**
                 * Static representation of the {@link customerConditionGroup2} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                CUSTOMER_CONDITION_GROUP_2: fieldBuilder.buildEdmTypeField('CustomerConditionGroup2', 'Edm.String', true),
                /**
                 * Static representation of the {@link customerConditionGroup3} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                CUSTOMER_CONDITION_GROUP_3: fieldBuilder.buildEdmTypeField('CustomerConditionGroup3', 'Edm.String', true),
                /**
                 * Static representation of the {@link customerConditionGroup4} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                CUSTOMER_CONDITION_GROUP_4: fieldBuilder.buildEdmTypeField('CustomerConditionGroup4', 'Edm.String', true),
                /**
                 * Static representation of the {@link customerConditionGroup5} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                CUSTOMER_CONDITION_GROUP_5: fieldBuilder.buildEdmTypeField('CustomerConditionGroup5', 'Edm.String', true),
                /**
